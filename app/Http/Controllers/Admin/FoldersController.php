...
class FoldersController extends Controller
{
     ...
     *
     * @param StoreFoldersRequest $request
     * @return \Illuminate\Http\Response
     */
     ...
     *
     * @param UpdateFoldersRequest $request
     * @param  int $id
     * @return \Illuminate\Http\Response
     */
    ...
    public function show($id)
    {
        ...
        $created_bies = User::get()->pluck('name', 'id')->prepend(trans('quickadmin.qa_please_select'), '');$files = \App\File::where('folder_id', $id)->get();
